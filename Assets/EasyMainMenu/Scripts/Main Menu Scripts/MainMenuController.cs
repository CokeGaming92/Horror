...
public class MainMenuController : MonoBehaviour {
    ...
    public UnityEvent unityEventMenu;
    ...
    void playClickSound() {
        // Check if clickSound AudioClip is assigned
        if (clickSound != null)
        {
            // Create a new GameObject to play the sound
            GameObject soundGameObject = new GameObject("ClickSound");
            AudioSource audioSource = soundGameObject.AddComponent<AudioSource>();

            // Set the clip to the click sound and play it
            audioSource.clip = clickSound;
            audioSource.Play();

            // Destroy the GameObject after the sound has finished playing
            Destroy(soundGameObject, clickSound.length);
        }
        else
        {
